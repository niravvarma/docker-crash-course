...
Run com.niravvarma.springboot.web.SpringBootFirstWebApplication as a Java Application.
...
- http://localhost:8080/login with niravvarma/dummy as credentials
- You can add, delete and update your todos
- Spring Security is used to secure the application
- `com.niravvarma.springboot.web.security.SecurityConfiguration` contains the in memory security credential configuration.
...
```
docker container run -p 8080:8080 --link=mysql -e RDS_HOSTNAME=mysql  niravvarma/todo-web-application-mysql:0.0.1-SNAPSHOT
```

Using Custom Network

```
docker container run -p 8080:8080 --network=web-application-mysql-network -e RDS_HOSTNAME=mysql  niravvarma/todo-web-application-mysql:0.0.1-SNAPSHOT
```
...
+----+--------------+---------+----------------------------+-------------+
|  1 | Default Desc | 0       | 2019-06-26 18:30:00.000000 | niravvarma |
+----+--------------+---------+----------------------------+-------------+
